...
\usepackage{xcolor}
\definecolor{niured}{cmyk}{0.2,1,.85,.06}
\definecolor{niugray}{cmyk}{0,0,0,.5}
\usepackage{sectsty}
\sectionfont{\fontspec{Gill Sans}\mdseries\Large\color{niured}\textsc{}}
...
{\fontspec{Gill Sans}\huge\color{niured}\uppercase{{\so{$author$}}}}


{\hspace{0 mm}\fontspec{Gill Sans}\color{niugray}\uppercase{{$department$}}}\hfill\faPhone \hspace{1 mm} {$phone$}\\
{\fontspec{Gill Sans}\color{niugray}\uppercase{{$school$}}}\hfill \hfill\faEnvelope \hspace{1 mm}\href{mailto:}{\tt $email$}\\
{\fontspec{Gill Sans}\color{niugray}\uppercase{{$institution$}}}\hfill\faGlobe \hspace{1 mm}\href{http://$web$}{\tt $web$}\\
{\fontspec{Gill Sans}\color{niugray}\uppercase{{$address$}}}\hfill\orcidlink{$orcid$} \hspace{.5 mm}\href{https://orcid.org/$orcid$}{\tt $orcid$}
